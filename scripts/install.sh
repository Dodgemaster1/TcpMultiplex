...
#   curl -fsSL https://raw.githubusercontent.com/Dodgemaster1/MulTCPlex/main/scripts/install.sh | sh -s -- --version v1.2.3
#   curl -fsSL https://raw.githubusercontent.com/Dodgemaster1/MulTCPlex/main/scripts/install.sh | sh -s -- --install-dir /usr/local/bin
set -eu
