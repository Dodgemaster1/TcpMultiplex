# multcplex installer -- generated by tinfoil 0.2.22
#
# Usage (in PowerShell):
#   iex (irm https://raw.githubusercontent.com/Dodgemaster1/MulTCPlex/main/scripts/install.ps1)
#   iex "& { $(irm https://raw.githubusercontent.com/Dodgemaster1/MulTCPlex/main/scripts/install.ps1) } -Version v1.2.3"
#   iex "& { $(irm https://raw.githubusercontent.com/Dodgemaster1/MulTCPlex/main/scripts/install.ps1) } -InstallDir 'C:\tools'"
#
# Or download and run manually:
#   irm https://raw.githubusercontent.com/Dodgemaster1/MulTCPlex/main/scripts/install.ps1 -OutFile install.ps1
